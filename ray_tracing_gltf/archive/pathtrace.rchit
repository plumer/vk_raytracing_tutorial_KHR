...
layout(set = 1, binding = kDsbTextures) uniform sampler2D texturesMap[]; // all textures
...
void main()
{
  ...
  prd.ray_origin    = rayOrigin;
  prd.ray_direction = rayDirection;
  prd.hitValue     = emittance;
  prd.bsdf_weight       = BRDF * cos_theta / p;
  return;
}
